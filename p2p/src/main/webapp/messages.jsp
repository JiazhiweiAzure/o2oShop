	...
	<div id="footer" class="ft">
				...
				<dl>
					<dd>
						<p>
							...
							官方交流群:<em>942224281</em><br> 工作日 9:00-22:00 / 周六 9:00-18:00<br>
						</p>
						<div class="ft-serv-handle clearfix">
							<a class="icon-hdSprite icon-ft-sina a-move a-moveHover"
								title="易得金融新浪微博" target="_blank" href="#"></a><a
								class="icon-hdSprite icon-ft-qqweibo a-move a-moveHover"
								title="易得金融腾讯微博" target="_blank" href="#"></a><a
								class="icon-ft-qun a-move a-moveHover" title="易得金融QQ群"
		...
		<div class="ft-record">
			...
			<div class="ft-identity">
				©2019 易得金融 All rights reserved&nbsp;&nbsp;&nbsp;<span
					class="color-e6">|</span>&nbsp;&nbsp;&nbsp;辽宁省易得金融投资管理有限公司&nbsp;&nbsp;&nbsp;<span
