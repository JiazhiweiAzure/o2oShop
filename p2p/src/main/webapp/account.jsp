...
<%--    <div class="credit-ad"><img src="images/clist1.jpg" width="1200" height="96"></div>--%>
    ...
    <div class="personal-main">
      <div class="personal-zhsz">
        ...
        <ul>
          ...
          <li><i class="grzxbg p-right"></i><span class="zhsz-span1">支付密码</span><span class="zhsz-span2"></span><span class="zhsz-span3"><a href="javascript:void(0)" onclick="showSpan('alert-updatePass')">更改</a></span></li>
        </ul>
      </div>
    </div>
    <script type="text/javascript">
		...
		$(document).ready(function(){
			...
			function check(){
				$.getJSON('identifying.do',null,function(data){
					...
					alert("验证码已发送");
					document.getElementById("yan").value=conent;
				});
			}
			function yanzhen(){
				var i= $("#yan").val();
				 var cont=$("#yanzhenma").val();
				 var phones=$("#newPhone").val();
				 if(cont!=i){
					 document.getElementById("sss").innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;验证码输入错误";
	        	   	  return false; 
				}else if(cont==""){
					 document.getElementById("sss").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;验证码不能为空";
					 return false;
				}else if(phones==""){
					 document.getElementById("a").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;手机号不能为空";
					 return false;
				}else if(phones.length>11||phones.length<11){
					 document.getElementById("a").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;请输入11位数的手机号";
					 return false;
				}else if(isNaN(phones)){
					 document.getElementById("a").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;请输入正确的手机号";
				       return false;
			    }else{
			    	alert("验证通过");
					 return true;
    ...
    <div class="alert-450" id="alert-checkOldMobile" style="display:none;">
      ...
      <div class="alert-main">
        <form id="checkOldMobileForm" name="checkOldMobileForm" method="post" action="<%=basePath%>updphone.do" enctype="application/x-www-form-urlencoded">
          <input type="hidden" name="checkOldMobileForm" value="checkOldMobileForm">
           <input type="hidden" value="${user.uid }" id="id" name="id">
          <ul> 
            <li>
            ...
            <li>
              <label class="txt-name">验证码</label>
              <input type="hidden" id="yan" >
              <input id="yanzhenma" type="text" name="checkOldMobileForm:checkOldMobileFormauthCode" class="txt110" maxlength="8" placeholder="请输入验证码">
            ...
            <li>	
            	<div id="sss" class="alert-error120" style="color: red;"></div>
            </li>
            <li>
            	<label class="txt-name">新手机号</label>
            	 <input id="newPhone" type="text" name="newPhone" class="txt235" onblur="phone();" placeholder="请输入新手机号">
            </li>
            <li>	
            	<div id="a" class="alert-error120" style="color: red;"></div>
            </li>
            <li>
              <input type="submit" name="checkOldMobileForm:j_idt129" value="确 认" class="btn-ok txt-right" onclick="return yanzhen()" >
            </li>
          </ul>
...
<div id="footer" class="ft">
    ...
    <div class="ft-service">
      <dl>
        <dd>
          ...
          <div class="ft-serv-handle clearfix"><a class="icon-hdSprite icon-ft-sina a-move a-moveHover" title="易得金融新浪微博" target="_blank" href="#"></a><a class="icon-hdSprite icon-ft-qqweibo a-move a-moveHover" title="易得金融腾讯微博" target="_blank" href="#"></a><a class="icon-ft-qun a-move a-moveHover" title="易得金融QQ群" target="_blank" href="#"></a><a class="icon-hdSprite icon-ft-email a-move a-moveHover mrn" title="阳光易贷email" target="_blank" href="mailto:xz@yirenbao.com"></a></div>
        </dd>
      </dl>
    </div>
  ...
  <div class="ft-record">
    ...
    <div class="ft-identity">©2015 易得金融 All rights reserved&nbsp;&nbsp;&nbsp;<span class="color-e6">|</span>&nbsp;&nbsp;&nbsp;安徽省易得金融投资管理有限公司&nbsp;&nbsp;&nbsp;<span class="color-e6">|</span>&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://www.miitbeian.gov.cn/">皖ICP备12345678号-1</a></div>
  </div>
</div>
</body>
</html>
