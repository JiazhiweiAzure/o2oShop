         		...
         		<div class="showback">
						...
						<i class="fa fa-angle-right">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              		<span class="help-block">请输入部门名称.(不超过10个汉字)</span>
                                  <input type="text" class="form-control" name="dname" maxlength="10">
                                  
                              </div>
                          </div>
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">部门描述：</label>
                              <div class="col-sm-10">
                                   <span class="help-block">请输入描述.(不超过50个汉字)</span>
                                  <textarea rows="3" cols="30" class="form-control" name="describe" maxlength="50">
									</textarea>	
