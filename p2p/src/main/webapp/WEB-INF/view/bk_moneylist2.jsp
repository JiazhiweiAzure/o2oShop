		...
		<section class="wrapper">
			<div class="showback">
				...
				<form id="frm1" class="form-horizontal tasi-form"
					action="<%=basePath%>/brower/qurey.do" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name=brelname class="form-control">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" name="btype">
								...
								<c:forEach var="list" items="${bList}">
									<option value="${list.id}">${list.bname}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10 ">
							<select name="bstate" class="form-control">
								<option value="请选择">请选择</option>
								<option value="1">筹资中</option>
								<option value="2">筹资完</option>
			...
			<div class="showback">
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
						...
						<tr align="center">
							<td colspan="13"><a
								href="${pageContext.request.contextPath}/brower/qurey.do?currpage=1"
								class="btn btn-success btn-ms ">首页</a> <a
								href="${pageContext.request.contextPath}/brower/qurey.do?currpage=${currpages-1}"
								class="btn btn-success btn-ms ">&lt;&lt;上一页</a> <a
								href="${pageContext.request.contextPath}/brower/qurey.do?currpage=${currpages+1}"
								class="btn btn-success btn-ms "> 下一页&gt;&gt;</a> <a
								href="${pageContext.request.contextPath}/brower/qurey.do?currpage=${totalpage}"
