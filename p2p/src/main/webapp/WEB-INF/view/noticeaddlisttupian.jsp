		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>首页图片
					</h4>
					<hr>
						...
						<c:forEach items="${list}" var="list" varStatus="status">
							<tr >
								...
								<td data-target="#${list.noticeid }" data-toggle="modal">
									...
									<c:if test="${list.noticetype=='6' }">首页图片</c:if>
								</td>
								<td data-target="#${list.noticeid }" data-toggle="modal">
								${ft:substring(list.noticecontent,0,50) }...
								</td>
								<td data-target="#${list.noticeid }" data-toggle="modal">
							  ...
							  <div class="modal-dialog">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        <div class="alert alert-danger"><b><font><font>图片描述: </font></font></b><font><font>${list.noticetitle }</font></font></div>
							        <div class="alert alert-info"><b><font><font>图片链接: </font></font></b><font><font>${list.noticecontent }</font></font></div>
