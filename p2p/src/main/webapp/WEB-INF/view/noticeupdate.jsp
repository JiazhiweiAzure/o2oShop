...
<html lang="en">
  <head>
    ...
    <meta name="keyword" content="Dashboard, Bootstrap, Administrator, Template, Theme, Responsive, Fluid, Retina">
   ...
   <!-- 导航栏 --><jsp:include page="common.jsp"></jsp:include>		
      ...
      <section id="main-content">
          <section class="wrapper"> 
          		<!-- 内容开始 -->
         		<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> 修改网站消息</h4>
				  		<!-- 页面内容 -->
                          ...
                          <div class="form-group" align="justify">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="noticetitle" class="form-control" value="${nots.noticetitle }">
                                  <input type="hidden"  name="noticepicture" value="${nots.noticepicture }">
                              </div>
                         </div>
							 <div class="form-group" align="justify">
                              ...
                              <div class="col-sm-10">
                                <select class="form-control" name="noticetype">
									  <option value="1" ${nots.noticetype=='1'?'selected':'' }>网站公告</option>
									  <option value="2" ${nots.noticetype=='2'?'selected':'' }>媒体报道</option>
									  <option value="3" ${nots.noticetype=='3'?'selected':'' }>管理团队</option>
									  <option value="4" ${nots.noticetype=='4'?'selected':'' }>合作伙伴</option>
									  <option value="5" ${nots.noticetype=='5'?'selected':'' }>团队风采</option>
									  <option value="6" ${nots.noticetype=='6'?'selected':'' }>首页图片</option>
									</select>
                              </div>
                         </div>
                         ...
                         <div class="form-group" align="justify">
                              <label class="col-sm-2 col-sm-2 control-label">图片</label>
                              <div class="col-sm-10">
                                  <img alt="" src="${nots.noticepicture }" width="80xp" height="100xp">
                              </div>
                         </div>
							 ...
							 <div class="form-group" align="justify">
                              ...
                              <div class="col-sm-10">
                              	  <textarea class="form-control" name="noticecontent" rows="3"  >${nots.noticecontent }</textarea>
                              </div>
                         </div>
