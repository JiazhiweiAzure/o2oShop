...
<meta name="keyword"
	content="Dashboard, Bootstrap, Administrator, Template, Theme, Responsive, Fluid, Retina">

<title>DASHGUM - FREE Bootstrap Administrator Template</title>
			...
			<div class="showback">
				...
				<form class="form-horizontal style-form" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="hidden" value="${ee.eid }">
							<input type="text" class="form-control" 
							onblur="return cename();" name="ename" id="ename" value="${ee.ename }">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<input type="radio" value="1" ${ee.esex=='男'?'checked':'' } name="esex">男
							<input type="radio" value="0" ${ee.esex=='女'?'checked':'' } name="esex">女
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">员工生日：</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
							 name="ebirths" id="ebirths" value="<fmt:formatDate value="${ee.ebirth }" 
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control"
							onblur="return ceidcard();" id="ebirths" name="eidcard" value="${ee.eidcard }">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">员工手机号：</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" 
							onblur="return cephone();" id="ephone" name="ephone" value="${ee.ephone }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
							onblur="return cemail();"id="email"	name="email" value="${ee.email }">
						</div>
							...
							<select name="edeptno">
								<c:forEach items="${dept }" var="dept">
									<option class="form-control" 
										 value="${dept.did }"
										 <c:if test="${dept.did==ee.edeptno}">selected</c:if>>
										 ${dept.dname }
									 </option>
								</c:forEach>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
							 onblur="return  cepostno();" id="epostno" readonly="readonly"	name="epostno" value="${ee.epostno }">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">入职时间：</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
							 name="etimes" id="etimes" value="<fmt:formatDate value="${ee.etime }" 
								pattern="yyyy-MM-dd"></fmt:formatDate>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" 
						onblur="return cepassword();"	name="epassword" value="${ee.epassword }">
						</div>
