		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 投资详情记录
					</h4>
					<hr>
								...
								<tr>
									...
									<td>
										<c:forEach items="${us}" var="us">
											<c:if test="${us.uid==list.userid }">
												${us.unickname}
											</c:if>
										</c:forEach>
									</td>
									<td>${list.inmoney}元</td>
									<td>${list.instyle}</td>
									<td>${list.profitmodel}</td>
									<td>${list.profitmoney}元</td>
									<td><fmt:formatDate value="${list.indate}" /></td>
									<td>${list.replaydate}天</td>
								</tr>
								<!-- 弹出框 -->
...
<!-- 								</div> -->
						...
						<tbody>
							<tr align="center">
								<td colspan="19"><a
									href="${pageContext.request.contextPath}/product/biaolist.do?currpage=1&bid=${bid}"
									class="btn btn-success btn-ms ">首页</a> <a
									href="${pageContext.request.contextPath}/product/biaolist.do?currpage=${currpages-1}&bid=${bid}"
									class="btn btn-success btn-ms ">&lt;&lt;上一页</a> <a
									href="${pageContext.request.contextPath}/product/biaolist.do?currpage=${currpages+1}&bid=${bid}"
									class="btn btn-success btn-ms "> 下一页&gt;&gt;</a> <a
									href="${pageContext.request.contextPath}/product/biaolist.do?currpage=${totalpage}&bid=${bid}"
