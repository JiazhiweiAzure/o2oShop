      ...
      <section id="main-content">
          <section class="wrapper"> 
         		...
         		<div class="showback">
				  		...
				  		<!-- 页面内容 -->
				  		<form id="frm1"  class="form-horizontal tasi-form" action="${pageContext.request.contextPath}/approve/addApprove.do" method="post">
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">认证项名称<font color="red"> *</font></label>
                                  <div class="col-lg-5">
                                      <input type="text" class="form-control" id="ainame" name="ainame" maxlength="15" required="required" >
                              ...
                              <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">认证项类型<font color="red"> *</font></label>
								  <div class="radio">
								  	<label >
								  	&nbsp;&nbsp;
								    <input type="radio" name="aitype" id="aitype" value="1" checked>
								   基本认证项
								  </label>
								  		  &nbsp;&nbsp;&nbsp;&nbsp;
								  		  &nbsp;&nbsp;&nbsp;&nbsp;
								  ...
								  <label>
								    <input type="radio" name="aitype" id="aitype" value="2">
								   可选认证项
								  </label>
								  </div><br/><br/>
								  <button type="button" class="btn btn-primary btn-lg btn-block" onclick="check_add();">点击提交</button>
							  </div>
