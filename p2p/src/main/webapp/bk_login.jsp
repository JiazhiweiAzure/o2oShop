			...
			<form class="form-login" id="fr" 
				...
				<div class="login-wrap">
					<input type="text" id="uid" class="form-control"
						name="ename" placeholder="用户名" autofocus> <br>
					 <input
						type="password" id="pwd" class="form-control"
						name="epassword" placeholder="密码">
					...
					<button id="bt" class="btn btn-theme btn-block" href="index.html"
						type="submit">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>请输入ID,并与系统管理员联系</p>
								<input type="text" name="email" placeholder="用户ID"
